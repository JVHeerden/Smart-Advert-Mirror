...
class StartPage(tk.Frame):
    ...
    def main_program(self):
        ...
        if face_found:
            ...
            self.emotion = 'No Emotion'
            App_Sockets.SendMessage(20004, self.emotion)
    ...
    def receive(self):
        ...
        print('waiting again')
        self.sock.listen(0)                              # Now wait for Client Connection.
        ...
        try:
            ...
            while True:
                ...
                temp_im = numpy.array(image_recv)
    ...
    def receive(self):
        ...
        print(self.host)
        self.sock.bind(('0.0.0.0', self.port))
        #self.sock.bind(("raspberrypi", self.port))
    ...
    def FeedDisplay(self, img):
        ...
        cv2.waitKey(1)
        faces = face_cascade.detectMultiScale(gray, 8, 5)
    ...
    def CallVision(self):
        ...
        self.lbDebug.insert(tk.END, "===============================================")
        self.lbDebug.insert(tk.END, "[INFO] Most Likely Emotion: " + self.emotion)
        self.lbDebug.insert(tk.END, "===============================================")
